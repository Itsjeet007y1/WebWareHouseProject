...
<title>Items Data Edit Page</title>
<link rel="stylesheet" type="text/css" href="../css/common.css">
</head>
<body>
	<center>
		<h1 style="color: orange">Data Edit Page!!!</h1>
		<hr>
		<form:form action="updateItem" method="post" modelAttribute="items">
				Item Id: <form:input path="itemId" readOnly="true"/><br>
			...
			<form:errors path="currency" cssClass="error"/><br><br>
				...
				<form:option value="">--Select--</form:option>
				<form:options items="${uomList}" itemLabel="uomModel"
					itemValue="uomId" />
			</form:select>
			<br>
			<br> Order Method (Sale Type): 
				<form:select path="itemSaleOrdMethod">
				<form:option value="">--Select--</form:option>
				<form:options items="${saleMode}" itemLabel="orderCode"
			...
			Item Vendors: 
				...
				<form:option value="">--Select--</form:option>
				<form:options items="${vendors}" itemLabel="whUserCode"
			...
			Item Customers:
				...
				<form:option value="">--Select--</form:option>
				<form:options items="${customers}" itemLabel="whUserCode"
					itemValue="whUserTypeId" />
			</form:select>
			<br>
			<br>
