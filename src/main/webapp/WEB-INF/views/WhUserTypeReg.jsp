...
<body>
	<center>
		<h1 style="color: lightgreen">Welcome to WareHouse User Type
			Page!!</h1>
		<hr><hr>
		<form:form action="insertWhUser" method="post" modelAttribute="whUserType">
		<table>
		<tr>
			<td>User Type:</td><td><form:radiobuttons path="whUserTyp" items="${whUserId}"/></td></tr>
		...
		<a href="getAllWhUserType">Click Here To Get All the Data</a>
	</center>
</body>
</html>